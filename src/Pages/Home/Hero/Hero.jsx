        ...
        <section className='slider-fixed-height flex items-center px-[15px] pt-[150px] pb-[100px] lg:pt-[200px] lg:pb-[150px] font-OpenSans'>
            <div className="container mx-auto grid grid-cols-12">
                <div className='space-y-5 col-span-12 xl:col-span-9'>
                    ...
                    <div>
                        <Link className='scale-100 hover:scale-90 bg-ezze-theme px-10 py-5 inline-flex mt-10 text-white text-base font-bold border-2 border-ezze-theme transition-all duration-300 hover:bg-transparent hover:text-ezze-theme' to='/'>See Our Projects</Link>
                    </div>
                </div>
            </div>
        </section>
