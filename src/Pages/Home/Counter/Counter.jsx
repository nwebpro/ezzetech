...
const Counter = () => {
    return (
        <section className='bg-counter-bg bg-cover bg-center bg-no-repeat relative z-0 after_style text-white py-[50px] md:py-20 lg:py[100px] font-OpenSans px-[15px]'>
            <div className="container mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-[30px]">
                    <div className='text-center space-y-4 lg:px-10'>
